      ...
      <div class="section-header">
        ...
        <div class="header-right">
          <p class="section-description">
            Welcome to our precious box - every customer is precious to us - it's only
            their trust and cooperation that make us who we are now. You can see a huge
            list from top-listed ones to new birds. We created every brand uniquely and
            gave them a new identity in the market.
          </p>
        </div>
      </div>
...
const testimonials = ref([
  ...
  },
  {
    ...
    date: "2023-12-19",
    review:
      "Had a good experience working with the FameSpreadMedia team. They are a dedicated and hardworking bunch.",
    hasMore: false,
  },
  {
  ...
  },
  {
    ...
    date: "2023-08-09",
    review:
      "FameSpreadMedia create our branding for many products,great experience with them,timely delivery,they have professional...",
    hasMore: true,
  },
  {
    name: "Rajesh Kumar",
    date: "2023-07-15",
    review:
      "Excellent branding and packaging design. The team understood our vision perfectly and delivered beyond expectations.",
    hasMore: false,
  },
  {
    name: "Priya Sharma",
    date: "2023-06-22",
    review:
      "Professional team with creative ideas. They transformed our brand identity completely.",
    hasMore: false,
  },
]);
...
.testimonial-card:hover {
  ...
  transform: translateY(-5px)
    translateX(calc((var(--index, 0) - var(--current, 0)) * 105%));
}
