            ...
            <div class="rating-summary">
                <div class="rating-box">
                    ...
                    <svg class="google-logo" viewBox="0 0 120 48" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.4 22.1c0-.7-.1-1.4-.2-2.1H8v4h4.1c-.2 1-.7 1.8-1.5 2.4v2h2.4c1.4-1.3 2.2-3.2 2.2-5.3z" fill="#4285F4"/>
                        <path d="M8 24c2 0 3.7-.7 4.9-1.8l-2.4-2c-.7.5-1.5.7-2.5.7-1.9 0-3.5-1.3-4.1-3H1.4v2.1C2.6 22.4 5.1 24 8 24z" fill="#34A853"/>
                        <path d="M3.9 14.9c-.3-.8-.3-1.7 0-2.5v-2.1H1.4C.5 12.1 0 14 0 16s.5 3.9 1.4 5.6l2.5-2.1c-.3-.5-.4-1-.4-1.6z" fill="#FBBC04"/>
                        <path d="M8 6.5c1.1 0 2 .4 2.8 1.1l2.1-2.1C11.7 4.3 10 3.5 8 3.5c-2.9 0-5.4 1.6-6.6 4l2.5 2.1c.6-1.7 2.2-3 4.1-3z" fill="#EA4335"/>
...
const testimonials = ref([
    ...
    },
    {
        name: 'Isha bhate',
        date: '2023-12-19',
        review: 'Had a good experience working with the expandbuzz team. They are a dedicated and hardworking bunch.',
        hasMore: false
    },
    {
    ...
    },
    {
        name: 'Vipin P',
        date: '2023-08-09',
        review: 'Expand buzz create our branding for many products,great experience with them,timely delivery,they have professional...',
        hasMore: true
    },
    {
        name: 'Rajesh Kumar',
